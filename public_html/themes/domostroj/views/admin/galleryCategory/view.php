...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo CHtml::link('<span class="fa fa-picture-o"></span> свойства альбома', Yii::app()->createUrl('/admin/galleryCategory/update', array('id' => $model->id)), array('class' => 'btn btn-xs btn-two')) ?>
    </div>
</div>
