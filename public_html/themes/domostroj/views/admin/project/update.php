...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo CHtml::link('<span class="fa fa-picture-o"></span> Доп. изображения', Yii::app()->createUrl('/admin/project/image', array('id' => $model->id)), array('class' => 'btn btn-xs btn-two')) ?>
